...
import com.project.service.contract.ErrorDetail;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetail> userExceptionHandler(UserException e, WebRequest request) {
        ErrorDetail err = new ErrorDetail(e.getMessage(), request.getDescription(false), LocalDateTime.now(), e.getReason());
