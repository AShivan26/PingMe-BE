...
public interface MessageService {
    ...
    List<MessageEntity> getChatsMessages(UUID chatId, UUID userId) throws ChatException, UserException;

    void deleteMessage(UUID messageId, UUID userId) throws MessageException, UserException;
}
