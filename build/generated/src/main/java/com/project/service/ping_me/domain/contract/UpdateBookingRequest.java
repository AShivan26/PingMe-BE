...
@Schema(name = "UpdateBookingRequest", description = "UpdateReservationRequest represents the request payload for updating a reservation")
...
public class UpdateBookingRequest {
  ...
  public UpdateBookingRequest charges(List<@Valid ChargeRequest> charges) {
    this.charges = charges;
    return this;
  }

  public UpdateBookingRequest addChargesItem(ChargeRequest chargesItem) {
  ...
  */
  ...
  public UpdateBookingRequest currency(String currency) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.charges, updateBookingRequest.charges) &&
        Objects.equals(this.currency, updateBookingRequest.currency);
  }
